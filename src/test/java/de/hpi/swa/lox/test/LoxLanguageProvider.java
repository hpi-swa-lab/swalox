...
public class LoxLanguageProvider implements LanguageProvider {
    ...
    public Collection<? extends Snippet> createValueConstructors(Context context) {
        return List.of(
            Snippet.newBuilder(
                "boolean",
                context.eval("lox", "fun makeTrue() { return true; }; return makeTrue;"),
            ...
            Snippet.newBuilder(
                "string",
                context.eval("lox", "fun makeString() { return \"Hello, World!\"; }; return makeString;"),
                TypeDescriptor.STRING).build(),
            Snippet.newBuilder(
                "array",
                context.eval("lox", "fun makeArray() { var a = []; a[0] = 1; a[1] = 2; return a; }; return makeArray;"),
                TypeDescriptor.ARRAY).build(),
            Snippet.newBuilder(
                "object",
                context.eval("lox", "class X {}; fun makeAnObject() { var x = X(); x.foo = 21; return x; }; return makeAnObject;"),
